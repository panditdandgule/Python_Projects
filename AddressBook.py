...
def add_contact():
    address_book_file = open("address_book_file.txt", "r")
    is_file_empty = os.path.getsize("address_book_file.txt") == 0
    ...
    try:
        ...
        address_book_file = open("address_book_file.txt", "w")
...
def get_contact_info_from_user():
    try:
        ...
        contact_phone = int(input("Enter contact phone number\n"))
